<div class="theme_template" id="main-content" role="main">
	...
	<div class="portlet-layout row">
		<div class="col-md-1 portlet-column portlet-column-first" id="column-7">
		...
		<div class="col-md-2 portlet-column" id="column-9">
			${processor.processColumn("column-9", "portlet-column-content")}
		</div>
		<div class="col-md-1 portlet-column" id="column-10">
	...
	<div class="portlet-layout row">
		...
		<div class="col-md-8 portlet-column portlet-column-last" id="column-13">
